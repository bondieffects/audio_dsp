...
# Status LEDs (verify LED positions on your board)
...
# I/O Standards - Using LVCMOS for better signal integrity
...
# Audio signals benefit from LVCMOS (lower noise, better for high-frequency signals)
...
# MIDI and other digital signals
...
# Additional constraints for better signal integrity
set_instance_assignment -name CURRENT_STRENGTH_NEW DEFAULT -to led[0]
set_instance_assignment -name CURRENT_STRENGTH_NEW DEFAULT -to led[1]
set_instance_assignment -name CURRENT_STRENGTH_NEW DEFAULT -to led[2]
set_instance_assignment -name CURRENT_STRENGTH_NEW DEFAULT -to led[3]

# Clock constraints (defined in SDC file)
# Input delays for asynchronous inputs
set_instance_assignment -name SYNCHRONIZER_IDENTIFICATION AUTO -to reset_n
set_instance_assignment -name SYNCHRONIZER_IDENTIFICATION AUTO -to midi_rx
